<?php require 'menu.php';?>
            ...
            <div class="row">
                <h1><strong>Liste des étudiants non boursiers</strong><a href="insert.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"></span> Ajouter</a></h1>
                <table class="table table-striped table-bordered display" id="table">
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach($item->findNonBoursier() as $val) 
                      {
                        echo '<tr>';
